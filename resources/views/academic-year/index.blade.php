...
@section('content')
    ...
    <x-page-header title="Academic Year" subtitle="Master Data">
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('academic-year.index') }}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('academic-year.edit', $item->id) }}" class="btn btn-warning btn-sm">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                            ...
                                            data-url="{{ route('academic-year.destroy', $item->id) }}">
